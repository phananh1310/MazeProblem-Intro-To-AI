...
public class Maze extends Application implements Runnable {
    ...
    int rows = 7;          // number of rows of cells in maze, including a wall around edges
    int columns = 7;       // number of columns of cells in maze, including a wall around edges
    ...
    int speedSleep = 40;    // short delay between steps in making and solving maze
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("Maze Generator and Solve");
        stage.show();
